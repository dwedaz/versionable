...
``` bash
composer require dwedaz/versionable
```
...
$this->crud->addField([
    ...
    'type' => 'new_field_name',
    'view_namespace' => 'dwedaz.versionable::fields',
]);
```
...
cp -i vendor/dwedaz/versionable/src/resources/views/fields/field_name.blade.php resources/views/vendor/backpack/crud/fields/field_name.blade.php
```
...
```bash
composer remove dwedaz/versionable
```

## Change log

Changes are documented here on Github. Please see the [Releases tab](https://github.com/dwedaz/versionable/releases).
...
If you discover any security related issues, please email neo.dwedaz@gmail.com instead of using the issue tracker.

## Credits

- [Willy Yudithya][link-author]
...
[ico-version]: https://img.shields.io/packagist/v/dwedaz/versionable.svg?style=flat-square
[ico-downloads]: https://img.shields.io/packagist/dt/dwedaz/versionable.svg?style=flat-square

[link-packagist]: https://packagist.org/packages/dwedaz/versionable
[link-downloads]: https://packagist.org/packages/dwedaz/versionable
[link-author]: https://github.com/dwedaz
